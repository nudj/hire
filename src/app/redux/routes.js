...
module.exports = {
  ...
  '/jobs/new': require('../pages/add-job'),
  '/jobs/share-with-team': require('../pages/share-with-team'),
  '/jobs/:jobSlug/bonus': require('../pages/add-job-bonus'),
  ...
  '/messages/new/:recipientId': require('../pages/messages-pick-job'),
  '/messages/new/:recipientId/:jobId': require('../pages/messages-compose'),
