...
const expressRouters = {
  ...
  secure: [
    ...
    require('./pages/manage-survey-questions/router'),
    require('./pages/manage-survey-question/router'),
    ...
    require('./pages/company-integration/router'),
    require('./pages/add-job/router'),
    require('./pages/add-job-bonus/router'),
