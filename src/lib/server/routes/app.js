...
router.get('/jobs/:jobSlug/external/:personId', ensureLoggedIn, externalComposeHandler)
router.post('/jobs/:jobSlug/external/:personId', ensureLoggedIn, externalSaveHandler)
